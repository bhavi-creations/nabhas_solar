...
<head>
  ...
  <style>
    ...
    .solar-panels-hero-title span { color: #00aaff; }
    ...
    .solar-panels-pin:hover .solar-panels-pin-dot { transform: scale(1.4); background: #ff8c00; }
    ...
    /* Pin positions */
    .solar-panels-p-eleswaram        { top: 12%; right: 20%; animation-delay: 0.05s; }
    .solar-panels-p-tuni             { top: 22%; right: 14%; animation-delay: 0.1s; }
    .solar-panels-p-kakinada         { top: 37%; right: 9%;  animation-delay: 0.15s; }
    .solar-panels-p-rajahmundry      { top: 30%; left: 42%;  animation-delay: 0.2s; }
    .solar-panels-p-gokavaram        { top: 22%; left: 30%;  animation-delay: 0.25s; }
    .solar-panels-p-ravulapalem      { top: 47%; left: 32%;  animation-delay: 0.3s; }
    .solar-panels-p-ramachandrapuram { top: 42%; right: 22%; animation-delay: 0.35s; }
    .solar-panels-p-amalapuram       { top: 57%; right: 16%; animation-delay: 0.4s; }
    .solar-panels-p-razole           { top: 65%; left: 40%;  animation-delay: 0.45s; }
    ...
    .solar-panels-map-center-circle i { color: #00aaff; font-size: 1.6rem; }
    ...
    .solar-panels-contact-card:hover .solar-panels-contact-link { color: #ffffff !important; }
    .solar-panels-contact-card:hover .solar-panels-contact-icon-wrap { background: rgba(255,255,255,0.15); }
    ...
    .solar-panels-contact-icon { font-size: 1.5rem; color: #003087; transition: color 0.25s; }
